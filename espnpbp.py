...
df['Quarter'] = np.where(
              df['Detail'].str.contains('End'), df['Detail'].str.contains('End').cumsum(), np.nan) #finds where 'detail' contains the word End and displays sum of occurences, from stackoverflow
